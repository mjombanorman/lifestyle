        ...
        <div class="grid simple ">
            ...
            <div class="grid-body no-border">
                ...
                echo GridView::widget([
                    ...
                    'toolbar' => [
                            ['content' =>
                            Html::button('<i class="glyphicon glyphicon-plus"></i>', ['type' => 'button', 'title' => 'Add New Product', 'class' => 'showModalButton btn btn-primary', 'value' => Yii::$app->urlManager->createUrl(['/products/products/create'])]) . ' ' .
